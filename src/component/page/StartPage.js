    ...
    <>
      <MobileFrame>
        <div className='flex justify-center items-center flex-col gap-[10px]'>
          ...
          {/* 左上角甜點 */}
          <Image className='absolute top-0 left-0 m-2 md:m-4 w-[60px] md:w-[100px] z-5 pointer-events-none' src={sweet1Img} alt='sweet1' />
          {/* 右上角甜點 */}
          <Image className='absolute top-0 right-0 m-2 md:m-4 w-[60px] md:w-[100px] z-5 pointer-events-none' src={sweet2Img} alt='sweet2' />
          {/* 左下角甜點 */}
          <Image className='absolute bottom-0 left-0 m-2 md:m-4 w-[60px] md:w-[100px] z-5 pointer-events-none' src={sweet3Img} alt='sweet3' />
          {/* 右下角甜點 */}
          <Image className='absolute bottom-0 right-0 m-2 md:m-4 w-[60px] md:w-[100px] z-5 pointer-events-none' src={sweet4Img} alt='sweet4' />

          <div className='text-[#96895d] py-[8px] font-bold text-3xl flex justify-center items-center z-10'
            >喜久福小測驗
          </div>
          <div className='w-[70%] h-[1px] md:h-[2px] bg-[#b1a36e] rounded-full z-10'></div>

          <div className='text-[#96895d] text-center text-[15px] md:text-lg font-bold leading-loose tracking-wide z-10'>
            喜久福是日本宮城縣仙台市的名產，口感柔軟甜而不膩
          </div>
          <div className='text-[#96895d] text-center text-[15px] md:text-lg font-bold leading-loose tracking-wide z-10 mt-2'>
            每個人心中，都住著一顆喜久福<br/>
            你也許還在尋找自己是什麼樣的存在<br/>
            但別擔心，無論是哪一種風味<br/>
            都是值得被喜歡的模樣
